...
const { component, getClassNameRegister, getAllComponents } = require('../base.static')
...
module.exports = component(__filename, ({ getClassName, createStyleSheet }) => {
    ...
    return `
      ...
      <html lang="en">
        <head>
          ...
          <script src="${attrs.JSFiles.classNameRegister}" type="text/javascript"></script>
          <script src="${attrs.JSFiles.app}" type="text/javascript"></script>
  ...
  const renderCSS = function() {
    Object.entries(getAllComponents()).forEach(([ filename, component ]) => {
    ...
    createStyleSheet({
      ...
      '@global': {
        ...
        h1: {
          extend: [ theme.responsiveText(160) ]
        },
  ...
  return { renderCSS, renderHTML, getClassNameRegister }
})
